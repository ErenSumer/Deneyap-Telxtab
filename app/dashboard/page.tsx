    ...
    return (
      <div className="flex min-h-screen bg-[#0A0A0A] items-center justify-center">
        <div className="text-center space-y-4">
          <div className="w-16 h-16 mx-auto border-4 border-purple-500/20 border-t-purple-500 rounded-full animate-spin" />
          <p className="text-gray-400 text-lg">{redirectMessage}</p>
          <div className="bg-gray-900/50 backdrop-blur-lg rounded-xl p-4 mt-4 border border-purple-500/20">
